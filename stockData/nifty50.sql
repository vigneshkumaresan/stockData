...
nse_nifty50  as(
				...
				select trading_date,open_price,high_price,low_price,close_price,round(((close_price/previous_close)-1*100)::numeric,2) daily_volatility  
				from (
						select  
						trading_date,
						open as open_price, 
